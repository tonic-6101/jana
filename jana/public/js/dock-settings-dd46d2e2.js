...
import { markRaw as sn, openBlock as C, createElementBlock as z, createElementVNode as P, computed as j, unref as u, shallowRef as un, watch as pe, triggerRef as Jr, onScopeDispose as sr, ref as R, onUnmounted as Xe, watchEffect as Ae, onMounted as Se, cloneVNode as ur, h as ie, Fragment as be, defineComponent as V, inject as kn, provide as Tn, reactive as Ht, nextTick as ge, toRaw as Et, shallowReadonly as Nt, getCurrentScope as Kl, customRef as ii, toValue as Te, onBeforeUnmount as si, readonly as Gl, getCurrentInstance as Lt, effectScope as Yl, toRefs as Ue, isRef as wn, toHandlerKey as ui, camelize as Xl, toRef as di, Comment as ci, mergeProps as ee, createBlock as B, normalizeStyle as St, withCtx as q, renderSlot as F, Teleport as dr, createCommentVNode as J, renderList as pt, watchPostEffect as Jl, mergeDefaults as pi, createVNode as K, withModifiers as xe, withKeys as Mt, watchSyncEffect as fi, withMemo as vi, resolveDynamicComponent as dt, normalizeProps as Ie, createTextVNode as _e, toDisplayString as H, guardReactiveProps as qe, onBeforeMount as yi, toHandlers as mi, normalizeClass as ae, useSlots as Zl, withDirectives as Pe, vShow as Zr, mergeModels as Ko, useModel as Ql, useAttrs as ro, createSlots as Nn, vModelCheckbox as Jn, vModelText as Pt, createStaticVNode as hi, vModelSelect as Mo } from "/assets/dock/js/vendor/vue.esm.js";
...
function xi(e, o) {
  return C(), z("svg", bi, [...o[0] || (o[0] = [
    P("path", { d: "M18 6 6 18" }, null, -1),
    P("path", { d: "m6 6 12 12" }, null, -1)
  ])]);
}
...
function Si(e, o) {
  return C(), z("svg", _i, [...o[0] || (o[0] = [
    ...
    P("path", { d: "M12 16v-4" }, null, -1),
    P("path", { d: "M12 8h.01" }, null, -1)
  ])]);
}
...
function $i(e, o, t) {
  let r = R(t == null ? void 0 : t.value), n = j(() => e.value !== void 0);
  return [j(() => n.value ? e.value : r.value), function(l) {
...
function ns(e, o) {
  let t = R(al(e.value.type, e.value.as));
  return Se(() => {
...
cs(() => {
  function e(o) {
    o.target instanceof HTMLElement && o.target !== document.body && Vt[0] !== o.target && (Vt.unshift(o.target), Vt = Vt.filter((t) => t != null && t.isConnected), Vt.splice(10));
  }
...
let fa = Symbol("VirtualContext"), hs = V({ name: "VirtualProvider", setup(e, { slots: o }) {
  ...
  }), n = Li(j(() => ({ scrollPaddingStart: r.value.start, scrollPaddingEnd: r.value.end, count: t.virtual.value.options.length, estimateSize() {
    return 40;
  }, getScrollElement() {
  ...
  let n = R(1), l = R(null), a = R(null), i = R(null), s = R(null), c = R({ static: !1, hold: !1 }), d = R([]), p = R(null), f = R(2), v = R(!1);
  function y(M = ($) => $) {
    let $ = p.value !== null ? d.value[p.value] : null, I = M(d.value.slice()), k = I.length > 0 && I[0].dataRef.order.value !== null ? I.sort((U, oe) => U.dataRef.order.value - oe.dataRef.order.value) : Ji(I, (U) => he(U.dataRef.domRef)), N = $ ? k.indexOf($) : null;
    return N === -1 && (N = null), { options: k, activeOptionIndex: N };
  }
  let m = j(() => e.multiple ? 1 : 0), x = j(() => e.nullable), [w, h] = $i(j(() => e.modelValue), (M) => r("update:modelValue", M), j(() => e.defaultValue)), _ = j(() => w.value === void 0 ? wt(m.value, { 1: [], 0: void 0 }) : w.value), S = null, g = null;
  function b(M) {
    return wt(m.value, { 0() {
      return h == null ? void 0 : h(M);
    }, 1: () => {
      let $ = Et(T.value.value).slice(), I = Et(M), k = $.findIndex((N) => T.compare(I, Et(N)));
      return k === -1 ? $.push(I) : $.splice(k, 1), h == null ? void 0 : h($);
    } });
  }
  let A = j(() => {
  });
  pe([A], ([M], [$]) => {
    if (T.virtual.value && M && $ && p.value !== null) {
      let I = M.indexOf($[p.value]);
      I !== -1 ? p.value = I : p.value = null;
    }
  });
  let T = { comboboxState: n, value: _, mode: m, compare(M, $) {
    if (typeof e.by == "string") {
      let I = e.by;
      return (M == null ? void 0 : M[I]) === ($ == null ? void 0 : $[I]);
    }
  ...
  }, defaultValue: j(() => e.defaultValue), nullable: x, immediate: j(() => !1), virtual: j(() => null), inputRef: a, labelRef: l, buttonRef: i, optionsRef: s, disabled: j(() => e.disabled), options: d, change(M) {
    h(M);
  }, activeOptionIndex: j(() => {
    if (v.value && p.value === null && (T.virtual.value ? T.virtual.value.options.length > 0 : d.value.length > 0)) {
      if (T.virtual.value) {
        let $ = T.virtual.value.options.findIndex((I) => {
          var k;
          return !((k = T.virtual.value) != null && k.disabled(I));
        });
        if ($ !== -1)
          return $;
      }
    ...
    v.value = !1, S !== null && cancelAnimationFrame(S), S = requestAnimationFrame(() => {
      ...
      p.value = N, f.value = I ?? 2, d.value = k.options;
    });
  }, selectOption(M) {
    ...
    let I = Ht({ id: M, dataRef: $ });
    if (T.virtual.value) {
      d.value.push(I);
      return;
    }
    g && cancelAnimationFrame(g);
    let k = y((N) => (N.push(I), N));
    p.value === null && T.isSelected($.value.value) && (k.activeOptionIndex = k.options.indexOf(I)), d.value = k.options, p.value = k.activeOptionIndex, f.value = 2, k.options.some((N) => !he(N.dataRef.domRef)) && (g = requestAnimationFrame(() => {
      let N = y();
    ...
    d.value = I.options, p.value = I.activeOptionIndex, f.value = 2;
  }, isSelected(M) {
  ...
  ts([a, i, s], () => T.closeCombobox(), j(() => n.value === 0)), Tn(pa, T), ds(j(() => wt(n.value, { 0: An.Open, 1: An.Closed })));
  let E = j(() => {
    var M;
  ...
  return Se(() => {
    ...
    var M, $, I;
    let { name: k, disabled: N, form: U, ...oe } = e, ne = { open: n.value === 0, disabled: N, activeIndex: T.activeOptionIndex.value, activeOption: T.activeOptionIndex.value === null ? null : T.virtual.value ? T.virtual.value.options[(M = T.activeOptionIndex.value) != null ? M : 0] : (I = ($ = T.options.value[T.activeOptionIndex.value]) == null ? void 0 : $.dataRef.value) != null ? I : null, value: _.value };
    return ie(be, [...k != null && _.value != null ? ua({ [k]: _.value }).map(([se, L]) => ie(ss, as({ features: aa.Hidden, key: se, as: "input", type: "hidden", hidden: !0, readOnly: !0, form: U, disabled: N, name: se, value: L }))) : [], Wt({ theirProps: { ...t, ...lo(oe, ["by", "defaultValue", "immediate", "modelValue", "multiple", "nullable", "onUpdate:modelValue", "virtual"]) }, ourProps: {}, slot: ne, slots: o, attrs: t, name: "Combobox" })]);
  };
} });
...
V({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(e, { attrs: o, slots: t, expose: r }) {
  ...
  let c = ns(j(() => ({ as: e.as, type: o.type })), a.buttonRef);
  return () => {
    var d, p;
...
let bs = V({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: !1 }, unmount: { type: Boolean, default: !0 }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: null } }, emits: { change: (e) => !0 }, setup(e, { emit: o, attrs: t, slots: r, expose: n }) {
  var l;
  let a = (l = e.id) != null ? l : `headlessui-combobox-input-${jn()}`, i = Kt("ComboboxInput"), s = j(() => pr(he(i.inputRef))), c = { value: !1 };
    ...
    pe([p, i.comboboxState, s], ([g, b], [A, T]) => {
      ...
      E && ((T === 0 && b === 1 || g !== A) && (E.value = g), requestAnimationFrame(() => {
        ...
        if (c.value || !E || ((M = s.value) == null ? void 0 : M.activeElement) !== E)
          return;
        let { selectionStart: $, selectionEnd: I } = E;
        Math.abs((I ?? 0) - ($ ?? 0)) === 0 && $ === 0 && E.setSelectionRange(E.value.length, E.value.length);
      }));
  ...
  function h(g) {
    var b, A, T;
    let E = (b = g.relatedTarget) != null ? b : Vt.find((M) => M !== g.currentTarget);
  ...
  let a = us(), i = j(() => a !== null ? (a.value & An.Open) === An.Open : n.comboboxState.value === 0);
  rs({ container: j(() => he(n.optionsRef)), enabled: j(() => n.comboboxState.value === 0), accept(c) {
  ...
  let n = Kt("ComboboxOption"), l = `headlessui-combobox-option-${jn()}`, a = R(null), i = j(() => e.disabled);
  r({ el: a, $el: a });
  let s = j(() => {
    var h;
  ...
  }), c = j(() => n.isSelected(e.value)), d = kn(fa, null), p = j(() => ({ disabled: e.disabled, value: e.value, domRef: a, order: j(() => e.order) }));
...
function $s(e = 1e3, o = {}) {
  const { controls: t = !1, callback: r } = o, n = yr(r ?? Ts, e, o), l = j(() => !n.isPending.value);
  return t ? {
    ready: l,
    ...n
  } : l;
...
function eo(...e) {
  const o = (r, n, l, a) => (r.addEventListener(n, l, a), () => r.removeEventListener(n, l, a)), t = j(() => {
...
function ma(e, o = {}) {
  const { immediate: t = !0, fpsLimit: r = null, window: n = Pn, once: l = !1 } = o, a = un(!1), i = j(() => {
    const v = Te(r);
    return v ? 1e3 / v : null;
  });
  let s = 0, c = null;
...
function et(e, o, t, r = {}) {
  var n, l;
  const { clone: a = !1, passive: i = !1, eventName: s, deep: c = !1, defaultValue: d, shouldEmit: p } = r, f = Lt(), v = t || (f == null ? void 0 : f.emit) || (f == null || (n = f.$emit) === null || n === void 0 ? void 0 : n.bind(f)) || (f == null || (l = f.proxy) === null || l === void 0 || (l = l.$emit) === null || l === void 0 ? void 0 : l.bind(f == null ? void 0 : f.proxy));
  let y = s;
...
const Hs = zs(), Us = /* @__PURE__ */ Ms(() => {
  const e = R(/* @__PURE__ */ new Map()), o = R(), t = j(() => {
...
function Ks(e) {
  const o = Lt(), t = o == null ? void 0 : o.type.emits, r = {};
...
function Gs(e) {
  const o = j(() => u(e)), t = j(() => new Intl.Collator("en", {
    usage: "search",
    ...o.value
  }));
  return {
...
function dn(e) {
  const o = Lt(), t = Object.keys((o == null ? void 0 : o.type.props) ?? {}).reduce((n, l) => {
...
function pu(e, o) {
  var x;
  const t = R({}), r = R("none"), n = R(e), l = e.value ? "mounted" : "unmounted";
  let a;
  ...
  return Xe(() => {
    v(), y();
  }), { isPresent: j(() => ["mounted", "unmountSuspended"].includes(s.value)) };
}
function Un(e) {
...
var Mn = V({
  ...
  setup(e, { slots: o, expose: t }) {
    var c;
    const { present: r, forceMount: n } = Ue(e), l = R(), { isPresent: a } = pu(r, l);
    t({ present: a });
...
function mu(e, o, t = !0) {
  var a;
  const r = ((a = o == null ? void 0 : o.value) == null ? void 0 : a.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), n = R(!1), l = R(() => {
  });
  return Ae((i) => {
    if (!ot || !Te(t))
      return;
...
function hu(e, o, t = !0) {
  var l;
  const r = ((l = o == null ? void 0 : o.value) == null ? void 0 : l.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), n = R(!1);
  return Ae((a) => {
    if (!ot || !Te(t))
      return;
    const i = async (s) => {
...
var gu = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, { forwardRef: n, currentElement: l } = ce(), a = j(() => {
      var v;
      return ((v = l.value) == null ? void 0 : v.ownerDocument) ?? globalThis.document;
    }), i = j(() => Ke.layersRoot), s = j(() => l.value ? Array.from(i.value).indexOf(l.value) : -1), c = j(() => Ke.layersWithOutsidePointerEventsDisabled.size > 0), d = j(() => {
...
var Au = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, { currentRef: n, currentElement: l } = ce(), a = R(null), i = xu(), s = Ht({
      paused: !1,
      pause() {
        this.paused = !0;
      },
...
function Ot(e = {}) {
  ...
  }), s = j(() => Array.from(n.itemMap.value.values())), c = j(() => n.itemMap.value.size);
  return {
    getItems: l,
    reactiveItems: s,
    itemMapSize: c,
...
var ju = /* @__PURE__ */ V({
  ...
  setup(e) {
    const o = e, { primitiveElement: t, currentElement: r } = It(), n = j(() => o.checked ?? o.value);
    return pe(n, (l, a) => {
      if (!r.value)
        return;
  ...
  setup(e) {
    const o = e, t = j(() => typeof o.value == "object" && Array.isArray(o.value) && o.value.length === 0 && o.required), r = j(() => typeof o.value == "string" || typeof o.value == "number" || typeof o.value == "boolean" || o.value === null || o.value === void 0 ? [{
      name: o.name,
      value: o.value
...
const Vu = ["top", "right", "bottom", "left"], Rt = Math.min, ze = Math.max, to = Math.round, Wn = Math.floor, ct = (e) => ({
  x: e,
  y: e
}), zu = {
  left: "right",
...
const ed = async (e, o, t) => {
  ...
  async fn(o) {
    ...
    const T = S / 2 - g / 2, E = A / 2 - m[y] / 2 - 1, M = Rt(p[w], E), $ = Rt(p[h], E), I = M, k = A - m[y] - $, N = A / 2 - m[y] / 2 + T, U = Zo(I, N, k), oe = !s.arrow && pn(n) != null && N !== U && l.reference[y] / 2 - (N < I ? M : $) - m[y] / 2 < 0, ne = oe ? N < I ? N - I : N - k : 0;
    return {
      [v]: f[v] + ne,
      data: {
        [v]: U,
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(o) {
      ...
      if (M = [...M, {
        ...
        let oe = (I = M.filter((ne) => ne.overflows[0] <= 0).sort((ne, se) => ne.overflows[1] - se.overflows[1])[0]) == null ? void 0 : I.placement;
        if (!oe)
          switch (v) {
            case "bestFit": {
              var k;
              const ne = (k = M.filter((se) => {
                if (b) {
                  const L = ut(se.placement);
                  return L === h || // Create a bias to the `y` side axis due to horizontal
                  // reading directions favoring greater width.
                  L === "y";
                }
                return !0;
              }).map((se) => [se.placement, se.overflows.filter((L) => L > 0).reduce((L, Z) => L + Z, 0)]).sort((se, L) => se[1] - L[1])[0]) == null ? void 0 : k[0];
              ne && (oe = ne);
              break;
            }
...
const ld = function(e) {
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(o) {
      ...
      const h = m - d.top - d.bottom, _ = y - d.left - d.right, S = Rt(m - d[x], h), g = Rt(y - d[w], _), b = !o.middlewareData.shift;
      let A = S, T = g;
      if ((t = o.middlewareData.shift) != null && t.enabled.x && (T = _), (r = o.middlewareData.shift) != null && r.enabled.y && (A = h), b && !f) {
        const M = ze(d.left, 0), $ = ze(d.right, 0), I = ze(d.top, 0), k = ze(d.bottom, 0);
        v ? T = y - 2 * (M !== 0 || $ !== 0 ? M + $ : ze(d.left, d.right)) : A = m - 2 * (I !== 0 || k !== 0 ? I + k : ze(d.top, d.bottom));
      }
      await s({
        ...o,
        availableWidth: T,
...
function Od(e, o) {
  ...
  for (; tt(a) && !an(a); ) {
    const i = nt(a), s = Er(a);
    !s && i.position === "fixed" && (n = null), (l ? !s && !n : !s && i.position === "static" && !!n && Cd.has(n.position) || In(a) && !s && Ta(e, a)) ? r = r.filter((d) => d !== a) : n = i, a = Dt(a);
  }
  return o.set(e, r), r;
}
function Ed(e) {
  ...
  const a = [...t === "clippingAncestors" ? yo(o) ? [] : Od(o, this._c) : [].concat(t), r], i = a[0], s = a.reduce((c, d) => {
    const p = Ol(o, d, n);
    return c.top = ze(p.top, c.top), c.right = Rt(p.right, c.right), c.bottom = Rt(p.bottom, c.bottom), c.left = ze(p.left, c.left), c;
  }, Ol(o, i, n));
  return {
...
function Hd(e, o, t) {
  t === void 0 && (t = {});
  const r = t.whileElementsMounted, n = j(() => {
    var A;
    return (A = on(t.open)) != null ? A : !0;
  }), l = j(() => on(t.middleware)), a = j(() => {
    var A;
  ...
  }), c = j(() => tr(e.value)), d = j(() => tr(o.value)), p = R(0), f = R(0), v = R(i.value), y = R(a.value), m = un({}), x = R(!1), w = j(() => {
    const A = {
      position: v.value,
      left: "0",
      top: "0"
...
var Gd = /* @__PURE__ */ V({
  ...
  emits: ["placed"],
  setup(e, { emit: o }) {
    const t = e, r = o, n = _a(), { forwardRef: l, currentElement: a } = ce(), i = R(), s = R(), { width: c, height: d } = su(s), p = j(() => t.side + (t.align !== "center" ? `-${t.align}` : "")), f = j(() => typeof t.collisionPadding == "number" ? t.collisionPadding : {
      top: 0,
      right: 0,
      bottom: 0,
      left: 0,
      ...t.collisionPadding
    }), v = j(() => Array.isArray(t.collisionBoundary) ? t.collisionBoundary : [t.collisionBoundary]), y = j(() => ({
      padding: f.value,
      ...
      $d({
        ...
        apply: ({ elements: k, rects: N, availableWidth: U, availableHeight: oe }) => {
          const { width: ne, height: se } = N.reference, L = k.floating.style;
          L.setProperty("--reka-popper-available-width", `${U}px`), L.setProperty("--reka-popper-available-height", `${oe}px`), L.setProperty("--reka-popper-anchor-width", `${ne}px`), L.setProperty("--reka-popper-anchor-height", `${se}px`);
        }
      }),
      s.value && zd({
        element: s.value,
    ...
    ]), w = j(() => t.reference ?? n.anchor.value), { floatingStyles: h, placement: _, isPositioned: S, middlewareData: g, update: b } = Hd(w, i, {
      ...
      middleware: x
    }), A = j(() => Jo(_.value)[0]), T = j(() => Jo(_.value)[1]);
    Jl(() => {
      S.value && r("placed");
    });
    const E = j(() => {
...
var Xd = /* @__PURE__ */ V({
  ...
  setup(e) {
    const { forwardRef: o } = ce(), t = Wd(), r = j(() => Yd[t.placedSide.value]);
    return (n, l) => {
      var a, i, s, c;
      return C(), z("span", {
        ref: (d) => {
...
var nc = /* @__PURE__ */ V({
  ...
  setup(e, { expose: o, emit: t }) {
    const r = e, n = t, { multiple: l, highlightOnHover: a, orientation: i, disabled: s, selectionBehavior: c, dir: d } = Ue(r), { getItems: p } = Ot({ isProvider: !0 }), { handleTypeaheadSearch: f } = wr(), { primitiveElement: v, currentElement: y } = It(), m = iu(), x = hr(d), w = br(y), h = R(), _ = R(!1), S = R(!0), g = /* @__PURE__ */ et(r, "modelValue", n, {
    ...
    const A = R(null), T = R(null), E = R(!1), M = R(!1), $ = /* @__PURE__ */ _n(), I = /* @__PURE__ */ _n(), k = /* @__PURE__ */ _n();
    function N() {
  ...
  setup(e, { emit: o }) {
    ...
    }), l = bo(), { primitiveElement: a, currentElement: i } = It(), s = j(() => t.disabled || l.disabled.value || !1), c = R();
    return fi(() => {
      var d;
      ...
      type: "text",
      onKeydown: [Mt(xe(u(l).onKeydownNavigation, ["prevent"]), [
        "down",
        "up",
        "home",
        "end"
      ]), Mt(u(l).onKeydownEnter, ["enter"])],
      onInput: p[0] || (p[0] = (f) => {
...
var vc = /* @__PURE__ */ V({
  ...
  emits: ["select"],
  setup(e, { emit: o }) {
    const t = e, r = o, n = yt(void 0, "reka-listbox-item"), { CollectionItem: l } = Ot(), { forwardRef: a, currentElement: i } = ce(), s = bo(), c = j(() => i.value === s.highlightedElement.value), d = j(() => ec(s.modelValue.value, t.value, s.by)), p = j(() => s.disabled.value || t.disabled);
    async function f(y) {
    ...
    return fc({ isSelected: d }), (y, m) => (C(), B(u(l), { value: y.value }, {
      default: q(() => [vi([c.value, d.value], () => K(u(ve), ee({ id: u(n) }, y.$attrs, {
        ...
        onClick: v,
        onKeydown: Mt(xe(v, ["prevent"]), ["space"]),
...
var bc = /* @__PURE__ */ V({
  ...
  setup(e, { expose: o, emit: t }) {
    var oe, ne, se;
    const r = e, n = t, { primitiveElement: l, currentElement: a } = It(), { multiple: i, disabled: s, ignoreFilter: c, resetSearchTermOnSelect: d, openOnFocus: p, openOnClick: f, dir: v, resetModelValueOnClear: y, highlightOnHover: m } = Ue(r), x = hr(v), w = /* @__PURE__ */ et(r, "modelValue", n, {
    ...
    async function _(L) {
      var Z, G;
      h.value = L, k.value = "", L ? (await ge(), (Z = l.value) == null || Z.highlightSelected(), g.value = !0, (G = A.value) == null || G.focus()) : (g.value = !1, setTimeout(() => {
        !L && r.resetSearchTermOnBlur && S.trigger();
      }, 1));
    }
    const S = /* @__PURE__ */ _n(), g = R(!1), b = R(!1), A = R(), T = R(), E = j(() => {
      var L;
      return ((L = l.value) == null ? void 0 : L.highlightedElement) ?? void 0;
    }), M = R(/* @__PURE__ */ new Map()), $ = R(/* @__PURE__ */ new Map()), { contains: I } = Gs({ sensitivity: "base" }), k = R(""), N = j((L) => {
    ...
    return Se(() => {
      var L, Z, G;
      U != null && U.exposed && (U.exposed.highlightItem = (L = l.value) == null ? void 0 : L.highlightItem, U.exposed.highlightFirstItem = (Z = l.value) == null ? void 0 : Z.highlightFirstItem, U.exposed.highlightSelected = (G = l.value) == null ? void 0 : G.highlightSelected);
    }), o({
      filtered: N,
      ...
      inputElement: A,
      highlightedElement: E,
      onInputElementChange: (L) => A.value = L,
      triggerElement: T,
      onTriggerElementChange: (L) => T.value = L,
      parentElement: a,
...
const [Mm, wc] = ke("ComboboxContent");
var _c = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, { position: n } = Ue(t), l = $t(), { forwardRef: a, currentElement: i } = ce();
    mr(t.bodyLock), gr(), xr(l.parentElement);
    const s = j(() => t.position === "popper" ? t : {}), c = dn(s.value), d = {
  ...
  setup(e, { emit: o }) {
    const n = cn(e, o), { forwardRef: l } = ce(), a = $t();
  ...
  setup(e) {
    const o = e, t = $t(), r = j(() => t.ignoreFilter.value ? t.allItems.value.size === 0 : t.filterState.value.count === 0);
...
var Tc = /* @__PURE__ */ V({
  ...
  setup(e) {
    const o = e, t = yt(void 0, "reka-combobox-group"), r = $t(), n = j(() => r.ignoreFilter.value ? !0 : r.filterSearch.value ? r.filterState.value.groups.has(t) : !0), l = kc({
      id: t,
      labelId: ""
    });
    return Se(() => {
  ...
  emits: ["update:modelValue"],
  setup(e, { emit: o }) {
    const t = e, r = o, n = $t(), l = bo(), { primitiveElement: a, currentElement: i } = It(), s = /* @__PURE__ */ et(t, "modelValue", r, { passive: t.modelValue === void 0 });
    Se(() => {
    ...
    return n.onResetSearchTerm(() => {
      ...
      onClick: f,
      onInput: d,
      onKeydown: Mt(xe(c, ["prevent"]), ["down", "up"]),
      onFocus: p
    }, {
      default: q(() => [F(y.$slots, "default")]),
      _: 3
  ...
  emits: ["select"],
  setup(e, { emit: o }) {
    const t = e, r = o, n = yt(void 0, "reka-combobox-item"), l = $t(), a = Ia(null), { primitiveElement: i, currentElement: s } = It();
    if (t.value === "")
  ...
  setup(e) {
    const o = e, { forwardRef: t, currentElement: r } = ce(), n = $t(), l = j(() => o.disabled || n.disabled.value || !1);
    return Se(() => {
...
var Nc = /* @__PURE__ */ V({
  ...
  setup(e) {
    const o = e, { forwardRef: t } = ce(), { nonce: r } = Ue(o), n = Ra(r), l = $t();
...
var Hc = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, n = Rn(), l = R(!1), a = R(!1), i = cn(t, r);
...
var ip = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    ...
    Ot({ isProvider: !0 });
    const y = hr(i), m = br(d), x = R(/* @__PURE__ */ new Set()), w = j(() => Array.from(x.value).map((S) => S.value).join(";"));
    function h(S) {
      if (a.value) {
...
var vp = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, n = qt();
    gr(), mr(t.bodyLock);
    const { CollectionSlot: l, getItems: a } = Ot(), i = R();
    xr(i);
    const { search: s, handleTypeaheadSearch: c } = wr(), d = R(), p = R(), f = R(), v = R(!1), y = R(!1), m = R(!1);
    function x() {
    ...
    Ae((b) => {
      ...
      const T = (M) => {
        ...
        A = {
          ...
          y: Math.abs(Math.round(M.pageY) - (((I = h.value) == null ? void 0 : I.y) ?? 0))
        };
      }, E = (M) => {
        var $;
    ...
    const S = j(() => t.position === "popper" ? t : {}), g = dn(S.value);
    return $a({
      content: i,
      viewport: d,
      onViewportChange: (b) => {
...
var gp = /* @__PURE__ */ V({
  ...
  emits: ["placed"],
  setup(e, { emit: o }) {
    const t = e, r = o, { getItems: n } = Ot(), l = qt(), a = xo(), i = R(!1), s = R(!0), c = R(), { forwardRef: d, currentElement: p } = ce(), { viewport: f, selectedItem: v, selectedItemText: y, focusSelectedItem: m } = a;
    function x() {
      if (l.triggerElement.value && l.valueElement.value && c.value && p.value && (f != null && f.value) && (v != null && v.value) && (y != null && y.value)) {
        ...
        const A = n().map((Y) => Y.ref), T = window.innerHeight - Ze * 2, E = f.value.scrollHeight, M = window.getComputedStyle(p.value), $ = Number.parseInt(M.borderTopWidth, 10), I = Number.parseInt(M.paddingTop, 10), k = Number.parseInt(M.borderBottomWidth, 10), N = Number.parseInt(M.paddingBottom, 10), U = $ + I + E + N + k, oe = Math.min(v.value.offsetHeight * 5, U), ne = window.getComputedStyle(f.value), se = Number.parseInt(ne.paddingTop, 10), L = Number.parseInt(ne.paddingBottom, 10), Z = _.top + _.height / 2 - Ze, G = T - Z, fe = v.value.offsetHeight / 2, re = v.value.offsetTop + fe, ye = $ + I + re, ue = U - ye;
        if (ye <= Z) {
          const Y = v.value === A[A.length - 1];
          c.value.style.bottom = "0px";
          const te = p.value.clientHeight - f.value.offsetTop - f.value.offsetHeight, le = Math.max(G, fe + (Y ? L : 0) + te + k), me = ye + le;
...
var Sp = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, n = cn(t, o), l = qt(), a = R();
    Se(() => {
      a.value = new DocumentFragment();
    });
    const i = R(), s = j(() => t.forceMount || l.open.value), c = R(s.value);
    return pe(s, () => {
...
var Op = /* @__PURE__ */ V({
  ...
  emits: ["select"],
  setup(e, { emit: o }) {
    const t = e, r = o, { disabled: n } = Ue(t), l = qt(), a = xo(), { forwardRef: i, currentElement: s } = ce(), { CollectionItem: c } = Ot(), d = j(() => {
      var S;
      return En((S = l.modelValue) == null ? void 0 : S.value, t.value, l.by);
    }), p = R(!1), f = R(t.textValue ?? ""), v = yt(void 0, "reka-select-item-text"), y = "select.select";
    async function m(S) {
  ...
  setup(e) {
    const o = e, t = qt(), r = xo(), n = qa(), { forwardRef: l, currentElement: a } = ce(), i = j(() => {
      var s, c;
      return {
        value: n.value,
  ...
  setup(e) {
    const o = e, t = qt(), { forwardRef: r, currentElement: n } = ce(), l = j(() => {
      var f;
  ...
  setup(e) {
    const o = e, { forwardRef: t, currentElement: r } = ce(), n = qt();
    Se(() => {
      n.valueElement = r;
    });
    const l = j(() => {
    ...
    }), a = j(() => l.value.length ? l.value.join(", ") : o.placeholder);
    return (i, s) => (C(), B(u(ve), {
      ref: u(t),
      as: i.as,
      "as-child": i.asChild,
...
var Vp = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    ...
    const { forwardRef: i, currentElement: s } = ce(), c = br(s), d = j(() => {
      var p;
    ...
    return Np({
      ...
      disabled: u(n),
      onClick: a,
      onKeydown: Mt(xe(a, ["prevent"]), ["enter"])
    }), {
...
const [Fa, Im] = ke("ToastProvider");
var Kp = /* @__PURE__ */ V({
  __name: "ToastAnnounce",
  setup(e) {
    const o = Fa(), t = $s(1e3), r = R(!1);
    return ma(() => {
      r.value = !0;
...
var nf = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, { forwardRef: n, currentElement: l } = ce(), { CollectionItem: a } = Ot(), i = Fa(), s = R(null), c = R(null), d = j(() => typeof t.duration == "number" ? t.duration : i.duration.value), p = R(0), f = R(d.value), v = R(0), y = R(d.value), m = ma(() => {
    ...
    const h = j(() => l.value ? Na(l.value) : null);
      ...
      default: q(() => [K(u(ve), ee({
        ...
        onPointermove: S[1] || (S[1] = (g) => {
          if (u(i).disableSwipe.value || !s.value)
            return;
          const b = g.clientX - s.value.x, A = g.clientY - s.value.y, T = !!c.value, E = ["left", "right"].includes(u(i).swipeDirection.value), M = ["left", "up"].includes(u(i).swipeDirection.value) ? Math.min : Math.max, $ = E ? M(0, b) : 0, I = E ? 0 : M(0, A), k = g.pointerType === "touch" ? 10 : 2, N = {
            x: $,
            y: I
          }, U = {
            originalEvent: g,
...
var yf = /* @__PURE__ */ V({
  ...
  setup(e) {
    ...
    ce();
    const s = R(!0), c = R(!1), { start: d, stop: p } = yr(() => {
      s.value = !0;
    }, r, { immediate: !1 });
    return vf({
      isOpenDelayed: s,
...
var gf = /* @__PURE__ */ V({
  ...
  setup(e, { emit: o }) {
    const t = e, r = o;
    ce();
    const n = jr(), l = j(() => t.disableHoverableContent ?? n.disableHoverableContent.value), a = j(() => t.disableClosingTrigger ?? n.disableClosingTrigger.value), i = j(() => t.disabled ?? n.disabled.value), s = j(() => t.delayDuration ?? n.delayDuration.value), c = j(() => t.ignoreNonKeyboardFocus ?? n.ignoreNonKeyboardFocus.value), d = /* @__PURE__ */ et(t, "open", r, {
      defaultValue: t.defaultOpen,
      passive: t.open === void 0
    });
    pe(d, (_) => {
    ...
    const p = R(!1), f = R(), v = j(() => d.value ? p.value ? "delayed-open" : "instant-open" : "closed"), { start: y, stop: m } = yr(() => {
      p.value = !0, d.value = !0;
    }, s, { immediate: !1 });
    function x() {
  ...
  setup(e, { emit: o }) {
    const t = e, r = o, n = wo(), { forwardRef: l, currentElement: a } = ce(), i = j(() => {
      var c;
  ...
  setup(e) {
    ...
    const { forwardRef: n, currentElement: l } = ce(), a = R(!1), i = R(!1), s = j(() => t.disabled.value ? {} : {
      click: m,
      focus: v,
      pointermove: p,
      pointerleave: f,
...
const Tf = { class: "rounded-lg border bg-surface-modal shadow-xl" }, jf = /* @__PURE__ */ V({
  ...
  setup(e, { expose: o, emit: t }) {
    const r = e, n = t;
    o({ open: x, close: w });
    const l = R(!1), a = R(!1), i = R(null), s = R(null), c = R(null), d = j({
      get: () => p.value ? r.show : l.value,
      set: (A) => {
        p.value || A !== l.value && (l.value = A, h(A));
      }
    }), p = j(() => r.show !== void 0), f = j(() => {
    ...
    const b = j(() => r.transition === "default");
    return Xe(() => {
      ...
      function(t) {
        ...
        "./node_modules/core-js/internals/define-iterator.js": (
          ...
          function(t, r, n) {
            ...
            t.exports = function(A, T, E, M, $, I, k) {
              a(E, T, M);
              var N = function(ye) {
                if (ye === $ && L)
                  return L;
              ...
              }, U = T + " Iterator", oe = !1, ne = A.prototype, se = ne[h] || ne["@@iterator"] || $ && ne[$], L = !w && se || N($), Z = T == "Array" && ne.entries || se, G, fe, re;
              if (Z && (G = i(Z.call(new A())), x !== Object.prototype && G.next && (!v && i(G) !== x && (s ? s(G, x) : typeof G[h] != "function" && d(G, h, b)), c(G, U, !0, !0), v && (y[U] = b))), $ == S && se && se.name !== S && (oe = !0, L = function() {
                return se.call(this);
              }), (!v || k) && ne[h] !== L && d(ne, h, L), y[T] = L, $)
                if (fe = {
                  values: N(S),
                  keys: I ? L : N(_),
                  entries: N(g)
...
const or = /* @__PURE__ */ Mf(If), Dl = Object.keys(or.icons), Rf = {
  ...
  setup(e) {
    const o = e, t = j(() => o.hoverDelay * 1e3);
...
}), $f = ["disabled", "ariaLabel", "type"], jt = /* @__PURE__ */ V({
  inheritAttrs: !1,
  __name: "Button",
  props: {
    theme: { default: "gray" },
  ...
  setup(e, { expose: o }) {
    const t = e, r = Zl(), n = gi(), l = j(() => {
      ...
      xl: "h-6",
      "2xl": "h-6"
    })[t.size]), i = j(() => t.disabled || t.loading), s = j(() => c.value ? t.label : null), c = j(() => t.icon || r.icon || d.value), d = j(() => {
      var m, x, w;
      if (!r.default)
        return !1;
      const v = r.default();
  ...
  setup(e, { expose: o, emit: t }) {
    const r = e, n = t, l = R(), a = R(!1), i = R(""), s = j(() => {
      var M;
    ...
    }), c = j(() => s.value.flatMap((E) => E.items)), d = (E) => E ? E.map((M) => g(M) ? M : { label: M.toString(), value: M }) : [], p = (E) => i.value ? E.filter((M) => M.label.toLowerCase().includes(i.value.trim().toLowerCase()) || M.value.toString().toLowerCase().includes(i.value.trim().toLowerCase())) : E, f = j({
      get() {
        if (!r.multiple)
    ...
    }, y = (E) => g(E) ? E : { label: E, value: E }, m = (E) => g(E) ? (E == null ? void 0 : E.label) || (E == null ? void 0 : E.value) : E, x = j(() => f.value ? r.multiple ? f.value.map((E) => m(E)).join(", ") : m(f.value) : ""), w = (E) => {
      if (!f.value)
        return !1;
      const M = g(E) ? E.value : E;
    ...
    return o({
      ...
      default: q(({ open: $ }) => [
        K(u(jf), {
          class: "w-full",
          show: a.value,
          "onUpdate:show": M[1] || (M[1] = (I) => a.value = I),
          ref_key: "rootRef",
          ref: A,
          placement: e.placement,
          "match-target-width": !0
        }, {
          target: q(({ open: I, togglePopover: k, close: N }) => [
          ...
          body: q(({ isOpen: I, togglePopover: k }) => [
            Pe(P("div", null, [
              P("div", {
...
function a1(e, o) {
  return C(), z("svg", l1, [...o[0] || (o[0] = [
    P("path", { d: "M20 6 9 17l-5-5" }, null, -1)
  ])]);
}
...
const p1 = { class: "flex flex-col gap-1" }, f1 = { class: "flex items-center" }, v1 = ["for"], y1 = {
  ...
  setup(e, { emit: o }) {
    ...
    return (d, p) => (C(), z("div", {
      ...
      K(u(zp), {
        ...
        onKeyup: p[1] || (p[1] = Mt(xe((f) => r.value = !r.value, ["self"]), ["space"])),
        class: ae(a.value),
        disabled: t.disabled
      }, {
        default: q(() => [
  ...
  setup(e, { expose: o, emit: t }) {
    const r = e, n = t, l = R(g(r.modelValue)), a = R(r.modelValue), i = R(!1), s = R(!1), c = R("");
    pe(
      () => r.modelValue,
      (L) => {
    ...
    const d = (L) => {
      ...
      a.value = L, n("update:modelValue", L), l.value = g(L), c.value = "", s.value = !1, n("update:selectedOption", Z);
    };
    function p(L) {
    ...
    const b = j(() => a.value ? S.value.find(
      (L) => m(L) === a.value
    ) : null), A = j(() => b.value ? w(b.value) : void 0), T = (L) => {
      if (!L.icon)
        return null;
      ...
      if (!Z)
        return !0;
      const fe = v(L).toLowerCase(), re = ((ue = y(L)) == null ? void 0 : ue.toLowerCase()) || "", ye = Z.toLowerCase();
    ...
    }, $ = j(() => i.value && !s.value && a.value ? r.options : M(r.options, l.value)), I = (L) => {
      const Z = L.target;
      l.value = Z.value, c.value = Z.value, s.value = !0, l.value === "" && (a.value = null, n("update:modelValue", null)), n("input", l.value);
    }, k = (L) => {
      i.value = L, L || (l.value = g(a.value)), s.value = !1;
    }, N = (L) => {
      r.openOnFocus && (i.value = !0), n("focus", L);
    }, U = (L) => {
      n("blur", L);
    }, oe = () => {
  ...
  emits: ["update:modelValue"],
  setup(e, { expose: o, emit: t }) {
    const r = e, n = t, l = Zl(), a = ro(), i = j(() => Object.fromEntries(
      // class and style is passed to the root element
      Object.entries(a).filter(([m]) => m !== "class" && m !== "style")
    )), s = R(null);
    o({ el: s });
    const c = j(() => r.disabled ? "text-ink-gray-5" : "text-ink-gray-8"), d = j(() => {
      let m = {
  ...
  emits: ["update:modelValue"],
  setup(e) {
    const o = Ql(e, "modelValue"), t = e, r = j(() => ({
      sm: "text-base",
      md: "text-base",
      lg: "text-lg",
      xl: "text-xl"
...
const E1 = /* @__PURE__ */ Ka(O1, [["__scopeId", "data-v-74c206f0"]]), k1 = { class: "space-y-1.5" }, T1 = ["for"], j1 = ["placeholder", "disabled", "id", "value", "rows"], P1 = /* @__PURE__ */ V({
  ...
  emits: ["update:modelValue"],
  setup(e, { expose: o, emit: t }) {
    const r = e, n = t, l = ro(), a = R(null), i = j(() => {
      let p = {
  ...
  setup(e) {
    ...
    return (r, n) => (C(), z("label", {
      ...
      e.required ? (C(), z(be, { key: 0 }, [
        ...
        n[1] || (n[1] = P("span", { class: "sr-only" }, "(required)", -1))
      ], 64)) : J("", !0)
    ], 10, M1));
  }
}), R1 = {
...
function L1(e, o) {
  return C(), z("svg", D1, [...o[0] || (o[0] = [
    P("path", { d: "m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3" }, null, -1),
    P("path", { d: "M12 9v4" }, null, -1),
    P("path", { d: "M12 17h.01" }, null, -1)
  ])]);
}
...
function Ja() {
  ...
  let le = !0, me = !0, Re = !1, Je = !0, We = !1, rt = !0, Bt = !1, _o = !1, So = !1, Xt = !1, Dn = !1, Ln = !1, Ir = !0, Rr = !1;
  ...
  const oi = t.createElement("form"), qr = function(O) {
    ...
    return O && X && De.insertBefore(t.createTextNode(X), De.childNodes[0] || null), Zt === gt ? E.call(W, Bt ? "html" : "body")[0] : Bt ? W.documentElement : De;
  }, Vr = function(O) {
    return A.call(
      O.ownerDocument || O,
      O,
  ...
  const Hr = function(O) {
    ...
    return O instanceof s && !ri(O) || (X === "noscript" || X === "noembed" || X === "noframes") && $e(/<\/no(script|embed|frames)/i, O.innerHTML) ? (at(O), !0) : (We && O.nodeType === xn.text && (W = O.textContent, Gn([I, k, N], (we) => {
      W = hn(W, we, " ");
    ...
    return O !== "annotation-xml" && Vo(O, L);
  }, Kr = function(O) {
    ...
    for (; we--; ) {
      ...
      if (X.attrName = en, X.attrValue = je, X.keepAttr = !0, X.forceKeepAttr = void 0, bt($.uponSanitizeAttribute, O, X), je = X.attrValue, Rr && (en === "id" || en === "name") && (Ft(Oe, O), je = Za + je), rt && $e(/((--!?|])>)|<\/(style|title|textarea)/i, je)) {
        Ft(Oe, O);
        continue;
      }
  ...
  return o.sanitize = function(Q) {
    ...
    if (_o || To(O), o.removed = [], typeof Q == "string" && (fn = !1), fn) {
      ...
      if (!Xt && !We && !Bt && // eslint-disable-next-line unicorn/prefer-includes
      Q.indexOf("<") === -1)
    ...
    let Ne = Bt ? W.outerHTML : W.innerHTML;
    return Bt && G["!doctype"] && W.ownerDocument && W.ownerDocument.doctype && W.ownerDocument.doctype.name && $e(Xa, W.ownerDocument.doctype.name) && (Ne = "<!DOCTYPE " + W.ownerDocument.doctype.name + `>
` + Ne), We && Gn([I, k, N], (xt) => {
      Ne = hn(Ne, xt, " ");
...
async function Le(e, o = {}) {
  const { call: t } = await import("./index-bafbccd5.js");
  return t(e, o);
}
const Wl = [
  "default_provider",
...
function yv() {
  const e = R(!1), o = R(!1), t = R(null), r = R(""), n = R([]), l = R([]), a = R([]), i = R({}), s = R(!1), c = R(!1), d = R(null), p = R({}), f = j(() => t.value ? JSON.stringify(t.value) !== r.value : !1);
  async function v() {
    try {
      const I = await Le("jana.api.agents.check_admin");
      e.value = I.is_admin;
    } catch {
      e.value = !1;
    }
  ...
  async function y() {
    s.value = !0;
    try {
      const I = await Le("frappe.client.get", {
  ...
  async function x() {
    try {
      ...
      try {
        const I = await Le("frappe.client.get_list", {
  ...
  async function w(I) {
    ...
    try {
      const k = await Le("jana.api.providers.get_models_for_provider", {
        provider_name: I
      });
      l.value = k;
    } catch {
  ...
  async function h(I) {
    ...
    try {
      ...
      return p.value[I] = N, N;
    } finally {
      d.value = null;
    }
  }
  async function _(I, k) {
    const N = await Le("jana.api.providers.save_provider", {
      provider_name: I,
      data: JSON.stringify(k)
    }), U = n.value.findIndex((oe) => oe.name === I);
  ...
  async function g(I) {
    await Le("jana.api.providers.delete_provider", {
      provider_name: I
    }), n.value = n.value.filter((k) => k.name !== I);
  }
  async function b() {
    try {
      const I = await Le("frappe.client.get_list", {
  ...
  async function E() {
    try {
      const I = await Le("jana.api.oauth.get_oauth_status");
      i.value = I;
    } catch {
      i.value = {};
    }
  }
  async function M(I, k) {
    const U = await Le(k === "google" ? "jana.api.oauth.initiate_google_oauth" : "jana.api.oauth.initiate_openrouter_oauth", { provider_name: I });
    window.location.href = U.auth_url;
  }
  async function $(I) {
    await Le("jana.api.oauth.disconnect_oauth", { provider_name: I }), await E();
  }
  return {
    isAdmin: e,
    roleLoaded: o,
...
const mv = { class: "flex items-center gap-2.5 min-w-0" }, hv = { class: "min-w-0" }, gv = { class: "flex items-center gap-2 flex-wrap" }, bv = { class: "text-sm font-semibold text-gray-900 truncate" }, xv = {
  ...
  setup(e, { emit: o }) {
    ...
    }), c = j(() => i.provider_type === "ollama" ? "http://localhost:11434" : i.provider_type === "vllm" ? "http://localhost:8000/v1" : i.provider_type === "openrouter" ? "https://openrouter.ai/api/v1" : D("Optional")), d = {
    ...
    }, p = j(() => d[t.provider.provider_type] ?? "bg-gray-100 text-gray-700");
    function f() {
      const v = {
    ...
    return (v, y) => (C(), z("div", {
      ...
      P("div", {
        ...
        P("div", mv, [
          ...
          P("div", hv, [
            P("div", gv, [
              P("h3", bv, H(e.provider.provider_name), 1),
              P("span", {
                class: ae(["inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium", p.value])
              }, H(e.provider.provider_type), 3),
              e.provider.is_default ? (C(), z("span", xv, H(u(D)("Default")), 1)) : J("", !0),
              e.provider.enabled ? J("", !0) : (C(), z("span", wv, H(u(D)("Disabled")), 1))
            ]),
            P("p", _v, [
      ...
      n.value ? (C(), z("div", Sv, [
        P("div", Cv, [
          P("div", null, [
            P("label", Av, H(u(D)("Provider Type")), 1),
            P("select", {
          ...
          P("div", kv, [
            ...
            P("label", Pv, [
              ...
              P("span", Mv, H(u(D)("Is Default")), 1)
            ])
          ])
        ]),
        P("div", null, [
          P("h4", Iv, H(u(D)("Connection")), 1),
          P("div", Rv, [
            P("div", null, [
              P("label", Dv, H(u(D)("Authentication")), 1),
              P("select", {
                value: i.auth_method,
                class: "w-full rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm focus:border-accent-400 focus:outline-none focus:ring-1 focus:ring-accent-400",
                onChange: y[4] || (y[4] = (m) => i.auth_method = m.target.value)
              }, [
                P("option", $v, H(u(D)("API Key")), 1),
                P("option", qv, H(u(D)("OAuth")), 1)
              ], 40, Lv)
            ]),
            P("div", null, [
              P("label", Bv, H(u(D)("API Base URL")), 1),
              Pe(P("input", {
              ...
              P("p", Nv, H(u(D)("Required for Ollama, vLLM, or custom endpoints.")), 1)
            ])
          ])
        ]),
        i.auth_method === "API Key" ? (C(), z("div", Vv, [
          P("label", zv, H(u(D)("API Key")), 1),
          P("div", Hv, [
            Pe(P("input", {
              "onUpdate:modelValue": y[6] || (y[6] = (m) => i.api_key = m),
              type: "password",
              placeholder: e.provider.has_api_key ? u(D)("••••••••  (key set, enter new to replace)") : u(D)("Paste your API key"),
        ...
        i.auth_method === "OAuth" && i.provider_type === "google" ? (C(), z("div", Wv, [
          P("label", Kv, H(u(D)("Connected App")), 1),
          Pe(P("input", {
            "onUpdate:modelValue": y[7] || (y[7] = (m) => i.connected_app = m),
            type: "text",
            placeholder: u(D)("Name of the Frappe Connected App for Google OAuth"),
            class: "w-full rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm placeholder:text-gray-300 focus:border-accent-400 focus:outline-none focus:ring-1 focus:ring-accent-400"
          }, null, 8, Gv), [
            [Pt, i.connected_app]
          ]),
          P("p", Yv, H(u(D)("Create a Connected App in Setup → Integrations → Connected App, then enter its name here.")), 1)
        ])) : J("", !0),
        P("div", null, [
          P("h4", Xv, H(u(D)("Models")), 1),
          P("label", Jv, H(u(D)("Available Models")), 1),
          Pe(P("textarea", {
            "onUpdate:modelValue": y[8] || (y[8] = (m) => i.available_models = m),
            rows: "3",
            placeholder: u(D)("Comma-separated list of available model names"),
            ...
            [Pt, i.available_models]
          ])
        ]),
        P("div", null, [
          P("h4", Qv, H(u(D)("Privacy")), 1),
          P("div", null, [
            P("label", ey, H(u(D)("PII Masking")), 1),
            P("select", {
              value: i.mask_pii_override,
              class: "w-full rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm focus:border-accent-400 focus:outline-none focus:ring-1 focus:ring-accent-400",
              onChange: y[9] || (y[9] = (m) => i.mask_pii_override = m.target.value)
            }, [
              P("option", ny, H(u(D)("Global Default")), 1),
              P("option", oy, H(u(D)("Always On")), 1),
              P("option", ry, H(u(D)("Always Off")), 1)
            ], 40, ty),
            P("p", ly, H(u(D)("Override the global PII masking setting for this provider. 'Global Default' inherits from Jana Settings.")), 1)
          ])
        ]),
        P("div", ay, [
          P("div", iy, [
            P("button", {
              ...
              e.testing ? (C(), z("div", uy)) : (C(), z(be, { key: 1 }, [
                _e(H(u(D)("Test Connection")), 1)
              ], 64))
            ], 8, sy),
            e.testResult ? (C(), z("span", dy, [
              e.testResult.success ? (C(), z("span", cy, H(u(D)("OK")) + " (" + H(e.testResult.latency_ms) + "ms)", 1)) : (C(), z("span", py, H(e.testResult.message), 1))
            ])) : J("", !0)
          ]),
          P("div", fy, [
            P("button", {
            ...
            P("button", {
              ...
              onClick: xe(f, ["stop"])
            }, H(l.value ? u(D)("Saving…") : u(D)("Save Provider")), 9, vy)
          ])
        ])
      ])) : J("", !0)
    ], 2));
  ...
  key: 5,
  class: "max-w-2xl"
}, Sm = { class: "flex items-center gap-3 border-t border-gray-200 dark:border-gray-700 px-1 py-4" }, Cm = {
  key: 0,
  ...
  __name: "Settings",
  setup(e) {
    const o = yv(), t = R(0), r = R(!1), n = R(!1), l = R(!1), a = Ht({
      provider_name: "",
    ...
    async function v(g, b) {
      try {
        await o.saveProvider(g, b), Ce.success(D("Provider saved"));
      } catch (A) {
        const T = A instanceof Error ? A.message : D("Failed to save provider");
        Ce.error(T);
      }
    }
    async function y(g) {
      if (confirm(D("Delete this provider? This cannot be undone.")))
        try {
          await o.deleteProvider(g), Ce.success(D("Provider deleted"));
        } catch (b) {
          const A = b instanceof Error ? b.message : D("Failed to delete provider");
          Ce.error(A);
        }
    }
    async function m() {
      ...
      try {
        ...
        }), Ce.success(D("Provider created")), n.value = !1, a.provider_name = "", a.provider_type = "openai", a.auth_method = "API Key", a.api_key = "", a.api_base_url = "", a.mask_pii_override = "Global Default", a.enabled = !0, a.is_default = !1;
      } catch (g) {
    ...
    async function x(g, b) {
      try {
        await o.addUserKey(g, b), Ce.success(D("API key added"));
      } catch {
    ...
    async function w(g) {
      try {
        await o.deleteUserKey(g), Ce.success(D("API key removed"));
      } catch {
    ...
    async function _(g) {
      try {
        await o.disconnectOAuth(g), Ce.success(D("Disconnected"));
      } catch {
    ...
    const S = V({
      ...
      setup(g, { emit: b }) {
        ...
        const $ = j(() => Object.entries(g.oauthStatus).map(([I, k]) => ({ key: I, ...k })));
            ...
            g.userKeys.length ? ie(
              ...
              g.userKeys.map(
                (I) => ie(
                  ...
                  [
                    ie("div", {}, [
                      ie("p", { class: "text-sm font-medium text-gray-900 dark:text-white" }, I.provider),
                      ie(
                        "p",
                        { class: "text-xs text-gray-500 dark:text-gray-400" },
                        I.auth_type === "api_key" ? D("API Key") + " •••••" : I.auth_type
                      )
                    ]),
                    ie(jt, {
                      label: D("Remove"),
            ...
            ie("div", { class: "rounded-lg border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4 space-y-3" }, [
              ...
              ie("div", { class: "grid gap-3 sm:grid-cols-2" }, [
                ie(kt, {
                  ...
                  options: g.providers.filter((I) => I.enabled).map((I) => ({ label: I.provider_name, value: I.name })),
                  modelValue: A.value,
                ...
                (I) => ie(
                  ...
                  [
                    ie("div", { class: "flex items-center gap-2" }, [
                      ie("span", { class: "text-sm font-medium text-gray-900 dark:text-white" }, I.provider_name),
                      ie(u1, {
                        label: I.connected ? D("Connected") : D("Not connected"),
                        theme: I.connected ? "green" : "gray",
                        variant: "subtle",
                        size: "sm"
                      })
                    ]),
                    I.connected ? ie(jt, {
                      ...
                      theme: "red",
                      size: "sm",
                      onClick: () => b("disconnect-oauth", I.key)
                    }) : ie(jt, {
                      label: D("Connect"),
                      variant: "solid",
                      size: "sm",
                      onClick: () => b("connect-oauth", I.key, I.provider_type)
                    })
                  ]
                )
              )
    ...
    return (g, b) => {
      ...
      return !u(o).roleLoaded.value || u(o).loading.value ? (C(), z("div", my, [...b[26] || (b[26] = [
        P("div", { class: "h-6 w-6 animate-spin rounded-full border-2 border-accent-600 border-t-transparent" }, null, -1)
        ...
        P("div", null, [
          ((A = i.value[t.value]) == null ? void 0 : A.label) === u(D)("General") ? (C(), z("div", xy, [
            P("div", wy, [
              P("h2", _y, H(u(D)("AI Provider")), 1),
              P("div", Sy, [
                P("div", Cy, [
                  K(u(kt), {
                    type: "select",
                    label: u(D)("Default Provider"),
                    options: s.value,
                ...
                K(u(kt), {
                  type: "number",
                  label: u(D)("Max Context Tokens"),
                  description: u(D)("Maximum tokens for the LLM context window (512–128000)"),
            ...
            P("div", Ay, [
              P("h2", Oy, H(u(D)("Behavior")), 1),
              P("div", Ey, [
                K(u(it), {
                  modelValue: u(o).settings.value.enable_streaming,
                  "onUpdate:modelValue": b[3] || (b[3] = (k) => u(o).settings.value.enable_streaming = k),
                  label: u(D)("Enable Streaming"),
                  description: u(D)("Stream AI responses token-by-token for a real-time feel")
                ...
                K(u(it), {
                  ...
                  label: u(D)("Enable Tool Calling"),
                  description: u(D)("Allow agents to call Frappe API tools during conversations")
                }, null, 8, ["modelValue", "label", "description"])
              ])
            ])
          ])) : ((T = i.value[t.value]) == null ? void 0 : T.label) === u(D)("Providers") ? (C(), z("div", ky, [
            P("div", Ty, [
              P("h2", jy, H(u(D)("Configured Providers")), 1),
              P("button", {
                class: "text-sm font-medium text-accent-600 hover:text-accent-700",
                onClick: b[5] || (b[5] = (k) => n.value = !n.value)
              }, H(n.value ? u(D)("Cancel") : "+ " + u(D)("Add Provider")), 1)
            ]),
            n.value ? (C(), z("div", Py, [
              P("h3", My, H(u(D)("New Provider")), 1),
              P("div", Iy, [
                P("div", null, [
                  P("label", Ry, H(u(D)("Provider Name")) + " *", 1),
                  Pe(P("input", {
                    "onUpdate:modelValue": b[6] || (b[6] = (k) => a.provider_name = k),
                    type: "text",
                    placeholder: u(D)("e.g. My OpenAI"),
                ...
                P("div", null, [
                  P("label", Ly, H(u(D)("Provider Type")) + " *", 1),
                  Pe(P("select", {
                ...
                P("div", null, [
                  P("label", $y, H(u(D)("Authentication")), 1),
                  Pe(P("select", {
                    "onUpdate:modelValue": b[8] || (b[8] = (k) => a.auth_method = k),
                    class: "w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent-500 dark:focus:ring-accent-400"
                  }, [
                    P("option", qy, H(u(D)("API Key")), 1),
                    P("option", By, H(u(D)("OAuth")), 1)
                  ], 512), [
                    [Mo, a.auth_method]
                  ])
                ]),
                P("div", null, [
                  P("label", Fy, H(u(D)("API Key")), 1),
                  Pe(P("input", {
                    "onUpdate:modelValue": b[9] || (b[9] = (k) => a.api_key = k),
                    type: "password",
                    placeholder: u(D)("Paste your API key"),
                ...
                P("div", null, [
                  P("label", Vy, H(u(D)("API Base URL")), 1),
                  Pe(P("input", {
                    "onUpdate:modelValue": b[10] || (b[10] = (k) => a.api_base_url = k),
                    type: "text",
                    placeholder: u(D)("Optional — for Ollama, vLLM, custom"),
                    class: "w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-white placeholder:text-gray-300 dark:placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-accent-500 dark:focus:ring-accent-400"
                  }, null, 8, zy), [
                    [Pt, a.api_base_url]
                  ])
                ...
                P("div", null, [
                  P("label", Hy, H(u(D)("PII Masking")), 1),
                  Pe(P("select", {
                    "onUpdate:modelValue": b[11] || (b[11] = (k) => a.mask_pii_override = k),
                    class: "w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent-500 dark:focus:ring-accent-400"
                  }, [
                    P("option", Uy, H(u(D)("Global Default")), 1),
                    P("option", Wy, H(u(D)("Always On")), 1),
                    P("option", Ky, H(u(D)("Always Off")), 1)
                  ], 512), [
              ...
              P("button", {
                ...
                onClick: m
              }, H(l.value ? u(D)("Creating…") : u(D)("Create Provider")), 9, Qy)
            ])) : J("", !0),
            !u(o).providers.value.length && !n.value ? (C(), z("div", em, H(u(D)("No providers configured.")), 1)) : J("", !0),
          ...
          ])) : ((E = i.value[t.value]) == null ? void 0 : E.label) === u(D)("Capabilities") ? (C(), z("div", nm, [
            P("div", om, [
              P("h2", rm, H(u(D)("AI Capabilities")), 1),
              P("p", lm, H(u(D)("Control what Jana is allowed to do in conversations")), 1),
              P("div", am, [
                K(u(it), {
                  modelValue: u(o).settings.value.enable_chat,
                  "onUpdate:modelValue": b[14] || (b[14] = (k) => u(o).settings.value.enable_chat = k),
                  label: u(D)("Chat / Q&A"),
                  description: u(D)("Basic conversational AI")
                }, null, 8, ["modelValue", "label", "description"]),
                K(u(it), {
                  ...
                  label: u(D)("Read Documents"),
                  description: u(D)("Allow AI to read Frappe documents for context")
                }, null, 8, ["modelValue", "label", "description"]),
                K(u(it), {
                  ...
                  label: u(D)("Draft Content"),
                  description: u(D)("Generate emails, descriptions, and summaries")
                }, null, 8, ["modelValue", "label", "description"]),
                K(u(it), {
                  ...
                  label: u(D)("Create Documents"),
                  description: u(D)("Allow AI to create new records in the system")
                }, null, 8, ["modelValue", "label", "description"]),
                K(u(it), {
                  modelValue: u(o).settings.value.enable_navigate,
                  "onUpdate:modelValue": b[18] || (b[18] = (k) => u(o).settings.value.enable_navigate = k),
                  label: u(D)("Navigate to Pages"),
                  description: u(D)("Allow AI to direct users to specific pages or reports")
                }, null, 8, ["modelValue", "label", "description"]),
                K(u(it), {
                  ...
                  label: u(D)("Run Report Queries"),
                  description: u(D)("Allow AI to query reports and return data")
                }, null, 8, ["modelValue", "label", "description"]),
                K(u(it), {
                  ...
                  label: u(D)("Modify Documents"),
                  description: u(D)("Allow AI to change existing records — use with caution")
                }, null, 8, ["modelValue", "label", "description"])
              ])
            ])
          ])) : ((M = i.value[t.value]) == null ? void 0 : M.label) === u(D)("Limits") ? (C(), z("div", im, [
            P("div", sm, [
              P("h2", um, H(u(D)("Rate Limits")), 1),
              P("div", dm, [
                K(u(kt), {
                  type: "number",
                  label: u(D)("Messages per User per Hour"),
                  description: u(D)("Set to 0 for unlimited"),
                ...
                K(u(kt), {
                  type: "number",
                  label: u(D)("Session Retention (days)"),
                  description: u(D)("Auto-archive sessions older than this. Set to 0 to keep forever."),
            ...
            P("div", cm, [
              P("h2", pm, H(u(D)("Privacy")), 1),
              K(u(it), {
                modelValue: u(o).settings.value.mask_pii,
                "onUpdate:modelValue": b[23] || (b[23] = (k) => u(o).settings.value.mask_pii = k),
                label: u(D)("Auto-Mask PII"),
                description: u(D)("Automatically mask personal identifiable information (names, emails, phone numbers) before sending to cloud LLM providers. Recommended for GDPR compliance.")
              }, null, 8, ["modelValue", "label", "description"])
            ])
          ])) : (($ = i.value[t.value]) == null ? void 0 : $.label) === u(D)("Knowledge") ? (C(), z("div", fm, [
            P("div", vm, [
              P("h2", ym, H(u(D)("Business Context")), 1),
              P("p", mm, H(u(D)("This description is included in every AI conversation to provide business context.")), 1),
              P("div", hm, [
                P("div", null, [
                  P("label", gm, H(u(D)("Business Description")), 1),
                  Pe(P("textarea", {
                    "onUpdate:modelValue": b[24] || (b[24] = (k) => u(o).settings.value.business_description = k),
                    rows: "6",
                    class: "w-full rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-accent-500 dark:focus:ring-accent-400",
                    placeholder: u(D)("Describe your business, products, and services...")
                  }, null, 8, bm), [
                    [Pt, u(o).settings.value.business_description]
                  ])
                ]),
                K(u(kt), {
                  type: "number",
                  label: u(D)("Knowledge Token Budget"),
                  description: u(D)("Maximum tokens allocated for knowledge articles in the system prompt"),
            ...
            P("p", xm, [
              P("a", wm, H(u(D)("Manage knowledge articles in Desk")) + " → ", 1)
            ])
          ])) : ((I = i.value[t.value]) == null ? void 0 : I.label) === u(D)("My Keys") ? (C(), z("div", _m, [
            K(u(S), {
        ...
        P("div", Sm, [
          K(u(jt), {
            label: u(o).saving.value ? u(D)("Saving…") : u(D)("Save"),
            variant: "solid",
            disabled: !u(o).dirty.value,
            loading: u(o).saving.value,
            onClick: p
          }, null, 8, ["label", "disabled", "loading"]),
          r.value ? (C(), z("span", Cm, H(u(D)("Saved")), 1)) : J("", !0)
        ])
      ], 64)) : (C(), z("div", Am, [
        K(u(S), {
          "user-keys": u(o).userKeys.value,
