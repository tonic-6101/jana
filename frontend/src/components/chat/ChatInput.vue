    ...
    <div class="flex items-end gap-2 max-w-3xl mx-auto">
      <textarea
        ...
        class="flex-1 resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-2.5
               text-sm focus:border-accent-400 focus:bg-white focus:outline-none focus:ring-1
               focus:ring-accent-400 disabled:opacity-50 disabled:cursor-not-allowed"
      />
      <button
        class="flex-shrink-0 rounded-lg bg-accent-600 p-2.5 text-white hover:bg-accent-700
